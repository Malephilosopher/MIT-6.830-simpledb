...
import java.simpledb.optimizer.LogicalPlan;
...
public class Parser {
    ...
    public Query handleQueryStatement(ZQuery s, TransactionId tId)
        ...
        if (physicalPlan != null) {
            Class<?> c;
            try {
                c = Class.forName("java.simpledb.optimizer.OperatorCardinality");
                ...
                c = Class.forName("java.simpledb.optimizer.QueryPlanVisualizer");
                m = c.getMethod(
