...
import jav.simpledb.storage.StringField;
...
import jav.simpledb.execution.*;
import jav.simpledb.optimizer.LogicalPlan;
...
public class Parser {
    ...
    public Query handleQueryStatement(ZQuery s, TransactionId tId)
        ...
        if (physicalPlan != null) {
            Class<?> c;
            try {
                c = Class.forName("jav.simpledb.optimizer.OperatorCardinality");
                ...
                c = Class.forName("jav.simpledb.optimizer.QueryPlanVisualizer");
                m = c.getMethod(
